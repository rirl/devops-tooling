...
echo "K8S Node 1"
call %DEVOPS_VMWARE_BIN%\vm-op.cmd start "E:\Users\rirl\Documents\Virtual Machines\do-wrk-01\do-wrk-01.vmx" nogui
call %DEVOPS_VMWARE_BIN%\vm-pause.cmd 30

echo "K8S Node 2"
call %DEVOPS_VMWARE_BIN%\vm-op.cmd start "E:\Users\rirl\Documents\Virtual Machines\do-wrk-02\do-wrk-02.vmx" nogui
call %DEVOPS_VMWARE_BIN%\vm-pause.cmd 15

echo AFTER  CLUSTER START
call %DEVOPS_VMWARE_BIN%\vm-list.cmd 